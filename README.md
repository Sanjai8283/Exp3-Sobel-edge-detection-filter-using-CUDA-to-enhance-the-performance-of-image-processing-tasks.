...
Thus the program has been executed by using CUDA to perform Sobel edge detection on a grayscale image and measure the performance for different block sizes on the GPU.
